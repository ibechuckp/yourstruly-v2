...
export default function PostscriptCreditsSection() {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-r from-[#C35F33]/5 via-[#D9C61A]/5 to-[#406A56]/5 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-center py-8">
            <Loader2 className="animate-spin text-[#C35F33]" size={24} />
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <Send size={20} className="text-[#C35F33]" />
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 glass rounded-full">
            ...
            <span className="font-bold text-[#C35F33]">{credits?.total_credits ?? 0}</span>
            {credits?.is_premium && <Crown size={14} className="text-[#D9C61A]" />}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button
            ...
            className="group glass rounded-2xl p-5 hover:bg-white/80 transition-all border border-[#C35F33]/20 
                       hover:border-[#C35F33]/40 hover:shadow-lg disabled:opacity-50 text-left"
          >
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#C35F33] to-[#E07A4E] 
                              flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-lg text-[#C35F33] mt-2 font-bold">
                  $5
                </p>
              </div>
            </div>
          ...
          <button
            ...
            className="group glass rounded-2xl p-5 hover:bg-white/80 transition-all border-2 border-[#D9C61A] 
          ...
          >
            ...
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#D9C61A] to-[#C35F33] 
                              flex items-center justify-center flex-shrink-0">
                <Sparkles size={28} className="text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-800 group-hover:text-[#D9C61A] transition-colors flex items-center gap-2">
                  5 Credits
          ...
          {!credits?.is_premium && (
            <Link
              ...
              className="group glass rounded-2xl p-5 hover:bg-white/80 transition-all border border-[#406A56]/20 
                         hover:border-[#406A56]/40 hover:shadow-lg"
            >
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#406A56] to-[#5A8A76] 
                                flex items-center justify-center flex-shrink-0">
                  <Crown size={28} className="text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-gray-800 group-hover:text-[#406A56] transition-colors">
                    Go Premium
                  </h3>
                  <p className="text-sm text-gray-600 mt-1">
