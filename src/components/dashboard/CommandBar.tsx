  ...
  return (
    <div className="p-3 sm:p-4 border-t border-white/10 sticky bottom-0 bg-black/20 backdrop-blur-sm">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 bg-gray-900/80 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/10">
