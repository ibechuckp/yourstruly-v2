...
export default async function ModerationPage() {
  ...
  const stats = [
    ...
    { label: 'Flagged Content', value: '0', icon: AlertTriangle, color: 'text-[#C35F33]' },
    { label: 'Approved Today', value: '0', icon: CheckCircle, color: 'text-[#406A56]' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-12 bg-white/40 backdrop-blur-sm rounded-xl border border-[#C35F33]/10 text-center">
        <Shield className="w-16 h-16 mx-auto text-[#406A56]/30" />
