    ...
    <div className="min-h-screen p-6 max-w-4xl space-y-6 pb-24">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/dashboard" className="p-2 bg-gray-900/90 rounded-xl text-white/70 hover:bg-white/20 hover:text-white transition-all border border-white/10">
            <ChevronLeft size={20} />
          </Link>
          <div>
...
function Section({ title, icon, children }: { title: string; icon: string; children: React.ReactNode }) {
  ...
  return (
    <div className="bg-gray-900/90 rounded-xl p-6 border border-white/10">
