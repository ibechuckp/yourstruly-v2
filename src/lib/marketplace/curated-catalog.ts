...
export const PRODIGI_PRODUCTS: CuratedProduct[] = [
  // PHOTOBOOKS
  {
    ...
    price: 45.00,
    currency: 'USD',
    images: ['/images/products/hardcover-photobook.svg'],
    thumbnail: '/images/products/hardcover-photobook.svg',
    provider: 'prodigi',
  ...
  },
  {
    ...
    price: 25.00,
    currency: 'USD',
    images: ['/images/products/softcover-photobook.svg'],
    thumbnail: '/images/products/softcover-photobook.svg',
    provider: 'prodigi',
    category: 'photobooks-memory-books',
    inStock: true,
    curatedScore: 85,
